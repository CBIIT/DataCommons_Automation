...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC3_Canine_Filter_Study-ALL.xlsx')

WebUI.click(findTestObject('Object Repository/Canine/Canine_Cases_Btn'))

WebUI.click(findTestObject('Object Repository/Canine/Canine_Filter_Study'))

WebUI.click(findTestObject('Object Repository/Canine/Canine_Filter_Study-COTB_Chkbx'))

WebUI.click(findTestObject('Object Repository/Canine/Canine_Filter_Study-NCATS_Chkbx'))
